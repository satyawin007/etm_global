	...
	@section('page_content')
		...
		<div class="row">
			<div class="col-xs-12" style="max-width: 98%;margin-left: 12px;">
				...
				<?php 
					$values = Input::All();
					if(isset($values["clientname"]) && isset($values["depot"]) && isset($values["month"])){		
				?>	
				...
				<div style="padding: 20px;">
					...
					<div class="modal-body no-padding">
						<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
							<thead>
								<tr>
									<th>Total Working Days</th><th>Total Due Amount</th><th>Leave Amount</th>
								</tr>
							</thead>
					...
					<div class="modal-body no-padding">
						<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
							<thead>
								<tr>
									<th>Late Joing Days</th>
									<th>Early Terminated Days</th>
