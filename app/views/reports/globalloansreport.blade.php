			...
			<div id="table1">
				<div class="row col-xs-12" style="padding-left:2%; padding-top: 1%">
					...
					<div class="table-header" style="margin-top: 10px;">
						<span>Results for GLOBAL LOANS REPORT</span>
						<span style="float:right; font-size: 16px; font-weight: bold;">Total Debit : <span id="dbamt">0.00</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Total Credit : <span id="cramt">0.00</span> &nbsp;&nbsp;&nbsp;</span>				 
					</div>
