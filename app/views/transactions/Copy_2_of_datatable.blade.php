				...
				<div class="row col-xs-12" style="padding-left:2%; padding-top: 2%">
					...
					<div class="clearfix">
						<div class="col-xs-12 input-group">
							...
							<div class="col-xs-3">
								<div class="form-group">
									<label class="col-xs-4 control-label no-padding-right" for="form-field-1"> TRANS TYPE<span style="color:red;">*</span> </label>
									<div class="col-xs-8">
										<select class="form-control" name="transtype" id="transtype" onchange="setTranType1Value(this.value)">
