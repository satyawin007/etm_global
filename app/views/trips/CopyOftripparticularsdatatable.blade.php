	...
	@section('page_content')
		<div class="row ">
			<div class="col-xs-offset-1 col-xs-10">
				...
				@include("trips.tripparticularsform",$form_info)
			</div>
		</div>
	...
	@section('inline_js')
		...
		<script type="text/javascript">
			...
			function getFields(val){
				$("#addfields").html('<div style="margin-left:500px; margin-top:10px;"><i class="ace-icon fa fa-spinner fa-spin orange bigger-125" style="font-size: 250% !important;"></i></div>');
				$.ajax({
			      url: "gettripparticularfields?lookupvalueid="+val,
