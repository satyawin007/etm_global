	...
	@section('page_content')		
		...
		<div class="widget-box">
			<div class="widget-header">
				...
				<div style="float:right;padding-right: 2%; margin-top: 1%"><a style="color: grey;" href="masters" title="masters"><span style="color:white"><i class="ace-icon fa fa-home bigger-200"></i></span></a> &nbsp; &nbsp;<a style="color: grey;"  title="{{$form_info['back_url']}}" href="{{$form_info['back_url']}}"><span style="color:white;"><i class="ace-icon fa fa-arrow-circle-left bigger-200"></i></span></a></div>
			</div>
